...
export default function NonprofitProfilePage() {
  ...
  return <main className="mx-auto max-w-6xl space-y-12 pb-10"><NonprofitOrganizationProfile /><PaymentProviderConnections /><NgoGoalsEditor orgId={profile.org_id} /></main>;
}
