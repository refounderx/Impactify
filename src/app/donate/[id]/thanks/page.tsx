  ...
  return (
    <div className="flex flex-col min-h-screen bg-raz-surface">
      <div className="max-w-2xl mx-auto w-full px-6 py-12 flex flex-col items-center text-center">
        ...
        <h1 className="text-3xl font-bold text-gray-800 mb-2">{t("thanks.title")}</h1>
        <p className="text-gray-500 mb-8">{t("thanks.sub")}</p>
        ...
        <div className="bg-white rounded-2xl p-5 w-full mb-6">
          <div className="flex justify-between items-center mb-2">
            <span className="text-gray-500 text-sm">{t("thanks.receiptNum")}</span>
            <span className="font-medium font-numeric text-sm">{receiptNum}</span>
          </div>
          <div className="flex justify-between items-center mb-2">
            <span className="text-gray-500 text-sm">{t("thanks.date")}</span>
            <span className="font-medium text-sm">27.06.2026</span>
          </div>
          <div className="flex justify-between items-center">
            <span className="text-gray-500 text-sm">{t("thanks.sentTo")}</span>
        ...
        {/* Share */}
        <div className="bg-white rounded-2xl p-5 w-full mb-6">
          <p className="font-bold text-gray-700 mb-1">{t("thanks.shareTitle")}</p>
          <p className="text-sm text-gray-500 mb-4">{t("thanks.shareSub")}</p>
        ...
        <div className="flex flex-col gap-3 w-full">
          <button className="flex items-center justify-center gap-2 border border-raz-teal text-raz-teal py-3.5 rounded-xl font-medium">
            <Download size={18} /> {t("thanks.downloadReceipt")}
          </button>
