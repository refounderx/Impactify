...
export default function MascotDonationForm() {
  ...
  return (
    <section className="max-w-lg mx-auto px-6 py-16 text-center">
      ...
      <h3 className="text-xl font-bold text-gray-900 mb-1">{t("landing.cta.mascotHeading1")}</h3>
      <p className="text-xl font-bold text-gray-900 mb-8">{t("landing.cta.mascotHeading2")}</p>
      ...
      >
        ...
        <button type="submit" className="bg-raz-teal text-white font-bold py-3 rounded-xl">
          {submitted ? "✓" : t("landing.cta.submit")}
        </button>
      </form>
    </section>
  );
