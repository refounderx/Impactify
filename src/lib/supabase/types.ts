  ...
  public: {
    Tables: {
      ...
      org_payment_connections: {
        Row: { id: string; org_id: string; provider: "cardcom" | "grow" | "gamma"; terminal_id: string; status: "setup_required" | "pending_verification" | "active" | "disabled" | "failed"; created_by: string | null; last_verified_at: string | null; created_at: string; updated_at: string };
    ...
    Functions: {
      ...
      remove_my_payment_method: { Args: { p_payment_method_id: string }; Returns: boolean };
      create_ngo_product: {
        Args: {
          p_name: string;
      ...
      get_ngo_payment_connections: { Args: Record<string, never>; Returns: { id: string; provider: "cardcom" | "grow" | "gamma"; terminal_id: string; status: "setup_required" | "pending_verification" | "active" | "disabled" | "failed"; last_verified_at: string | null; created_at: string }[] };
      start_ngo_payment_connection: { Args: { p_provider: "cardcom" | "grow" | "gamma"; p_terminal_id: string }; Returns: string };
    };
    Enums: {
      app_role: AppRole;
