...
async function main() {
  ...
  const tables = [
    ...
    "ngo_updates", "community_updates", "community_campaigns",
  ];
  ...
  if (schemaResponse.ok) {
    ...
    const requiredRpcs = ["/rpc/save_ngo_update", "/rpc/manage_ngo_update", "/rpc/save_community_update", "/rpc/manage_community_update", "/rpc/set_community_campaign"];
