...
- [x] Updates management restored to the reference design: working trigger/schedule tabs, search and category filtering, create/edit flows, and duplicate/pause/remove row actions. All mutations remain local UI state — see "Nonprofit Admin — Create Update Wizard" below
